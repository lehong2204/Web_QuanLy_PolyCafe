...
//                {
//                    Id = "OD" + Guid.NewGuid().ToString("N").Substring(0, 8).ToUpper(),
...
//            {
//                Id = orderId,
//                UserId = "U001", // Staff mặc định - có thể lấy từ session sau
...
//            return Json(new { success = true, orderId = orderId, total = totalPrice });
//        }
